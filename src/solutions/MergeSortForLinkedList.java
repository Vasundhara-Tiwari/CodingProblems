...
public class MergeSortForLinkedList {
    ...
    public static class LinkedList {
        ...
        public static LinkedList mergeTwoSortedLists(LinkedList l1, LinkedList l2) {
            ...
            Node firstListNode = l1.head;
            Node secondListNode = l2.head;
            while (firstListNode != null && secondListNode != null) {
                if (firstListNode.data < secondListNode.data) {
                    list.addLast(firstListNode.data);
                    firstListNode = firstListNode.next;
                } else {
                    list.addLast(secondListNode.data);
        ...
        public static LinkedList mergeSort(Node head, Node tail) {
            ...
            LinkedList result = LinkedList.mergeTwoSortedLists(l1, l2);
            return result;
        }
    }
}
